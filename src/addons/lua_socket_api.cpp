...
void registerSocketLuaAPI(lua_State* L) {
    static const luaL_Reg fns[] = {
        {.name = "SocketInventoryItem",        .func = lua_SocketInventoryItem},
        {.name = "SocketContainerItem",        .func = lua_SocketContainerItem},
        {.name = "GetNumSockets",              .func = lua_GetNumSockets},
        {.name = "GetSocketTypes",             .func = lua_GetSocketTypes},
        {.name = "GetExistingSocketInfo",      .func = lua_GetExistingSocketInfo},
        {.name = "GetExistingSocketLink",      .func = lua_GetExistingSocketLink},
        {.name = "GetNewSocketLink",           .func = lua_GetNewSocketLink},
        {.name = "GetNewSocketInfo",           .func = lua_GetNewSocketInfo},
        {.name = "GetSocketItemInfo",          .func = lua_GetSocketItemInfo},
        {.name = "GetSocketItemRefundable",    .func = lua_GetSocketItemRefundable},
        {.name = "GetSocketItemBoundTradeable", .func = lua_GetSocketItemBoundTradeable},
        {.name = "ClickSocketButton",          .func = lua_ClickSocketButton},
        {.name = "AcceptSockets",              .func = lua_AcceptSockets},
        {.name = "CloseSocketInfo",            .func = lua_CloseSocketInfo},
